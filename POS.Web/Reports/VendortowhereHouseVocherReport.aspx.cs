...
{
    public partial class VendortowhereHouseVocherReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("VendorToWhaereHouseVocher.rdlc");
               ...
               // var user = Session[WebUtil.CURRENT_USER] as UserViewModel;
                ...
                List<vendorWareHouseVoucherReporViewModel> list = VendorServices.GetReportvendorwarehouseById(ItemId).ToList();
